const CHARLIZE_ABI = [
  ...
  },
  {
    ...
    name: "PoppedAddressFromPendingStateArray",
    type: "event",
  },
  {
    inputs: [
      {
        internalType: "address",
        name: "addressInPendingState",
        type: "address",
      },
    ],
    name: "pushAddressInPendingState",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  {
    inputs: [],
    name: "getLengthAddressInPendingStateArray",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "getRoleNumberOfUserAddress",
    outputs: [
      {
        internalType: "uint256",
        name: "",
